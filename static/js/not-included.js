document.addEventListener('DOMContentLoaded', function() {
    const expandAllBtn = document.querySelector('.expand-all-not-included');
    const notIncludedItems = document.querySelectorAll('.not-included-item');
    ...
    notIncludedItems.forEach(item => {
        const header = item.querySelector('.not-included-item-header');
    ...
    function updateExpandAllState() {
        const allExpanded = Array.from(notIncludedItems).every(item => 
