document.addEventListener('DOMContentLoaded', function() {
    ...
    const expandAllBtnplus = document.querySelector('.expand-all-included.plus');
    const includedItems = document.querySelectorAll('.included-item');
    const includedItemsExtra = document.querySelectorAll('.included-item.extra');
    ...
    expandAllBtnplus.addEventListener('click', function() {
        isAllExpanded = !isAllExpanded;
        ...
        // Toggle all items
        includedItemsExtra.forEach(item => {
            item.classList.toggle('expanded', isAllExpanded);
        });
    });
